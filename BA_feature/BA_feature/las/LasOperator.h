...
===================================================================*/
class CLasOperator;
ostream& operator <<(ostream&,const PublicHeaderBlock pHeader);
class CLasOperator{

public:
	 CLasOperator();                                      // Constructor
	~ CLasOperator();                                     // Destructor
	friend ostream& operator << (ostream&,const PublicHeaderBlock pHeader);
	bool readLasFile(const char *file_name);              // Read an LAS file
	bool readXYZFile(const char *fil_ename);              // Read an XYZ file
	bool readASCFile(const char *fil_ename);              // Read an ASC file
	...
	bool writeLasFile(const char *file_name);
	bool writeLasFile(const char*file_name , vector<PointDataRecord>& records);
	bool writeLasFile(const char*file_name , vector<PointDataRecord>& records , vector<Point3D>& points);
